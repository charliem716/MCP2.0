...
async function debugTest3() {
  ...
  for (const event of events) {
    console.log(`Event: controlName=${event.controlName}, value=${event.value}, delta=${event.delta}, previousValue=${event.previousValue}, timestampMs=${event.timestampMs}`);
  }
