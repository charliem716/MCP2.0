...
describe('Tools Type Safety', () => {
  ...
  describe('Factory Functions Type Safety', () => {
    test('Factory functions should enforce type safety', () => {
      ...
      expect(createGetControlValuesTool(mockQrwcClient)).toBeInstanceOf(
        GetControlValuesTool
      );
      expect(createSetControlValuesTool(mockQrwcClient)).toBeInstanceOf(
        SetControlValuesTool
      );
      expect(createListComponentsTool(mockQrwcClient)).toBeInstanceOf(
        ListComponentsTool
      );
      expect(createGetComponentControlsTool(mockQrwcClient)).toBeInstanceOf(
        GetComponentControlsTool
      );
    });
  });
