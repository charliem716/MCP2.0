...
setTimeout(async () => {
  ...
  console.log(
    `- Node.js floating promise warnings: ${floatingPromiseWarnings.length}`
  );
  console.log(
    `- Process handled shutdown cleanly: ${proc.exitCode !== null ? 'Yes ✅' : 'No ❌'}`
  );
