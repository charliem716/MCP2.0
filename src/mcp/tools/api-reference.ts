...
export class QSysAPIReference {
  private methods: APIMethod[] = [
    ...
    // Component Methods
    {
      name: "Component.Get",
      category: "Component",
      description: "Get specific controls from a component (supports both single and multiple controls)",
      params: {
    ...
    },
    {
      ...
      example: {
        ...
        response: {
          controls: [
            { Component: "Main Gain", Name: "gain", Value: -10, String: "-10.0 dB" },
            { Component: "Main Gain", Name: "mute", Value: false, String: "unmuted" },
            { Component: "Room Combine", Name: "wall.1.open", Value: true, String: "open" },
            { Component: "Room Combine", Name: "wall.2.open", Value: false, String: "closed" }
          ]
        }
      }
    },
      ...
      example: {
        ...
        response: {
          ...
          Changes: [
            ...
            { Component: "My Component", Name: "gain", Value: -6, String: "-6dB" }
          ]
        }
      }
    },
